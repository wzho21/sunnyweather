...
class PlaceAdapater(private val fragment: PlaceFragment,private val placeList: List<Place>):RecyclerView.Adapter<PlaceAdapater.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.placeAddress.text=place.adm1+" "+place.adm2+" "+place.lon+"/"+place.lat
    }
